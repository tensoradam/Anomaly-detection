  ...
  const renderStep = () => {
    switch (step) {
        case 1:
            return (
              <React.Fragment>
              <Col className="mb-5 mb-xl-0" xl="3"></Col>
              <Col className="mb-5 mb-xl-0" xl="6">
                <Card className="shadow">
                  <CardHeader className="bg-transparent">
                    <Row className="align-items-center">
                      <div className="col">
                        <h6 className="text-uppercase text-dark ls-1">
                          Upload the CSV file
                        </h6>
                        <h3 className="text-black mb-0">Detection</h3>
                      </div>
                    </Row>
                  </CardHeader>
                  <CardBody>                    
                  <Row className="align-items-center">
                      <Col xl="4"></Col>
                      <div className="col align-items-center" xl="4">
                        <Input
                          type="file"
